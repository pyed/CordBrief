...
echo "=== CordBrief Production Collector Entrypoint ==="
...
# 8. Configure Openbox window manager with auto-maximize rules
...
# 9. Launch Xpra in desktop mode, forwarding all necessary environment variables to children
